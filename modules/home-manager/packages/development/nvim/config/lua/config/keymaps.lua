...
-- vim.keymap.set("n", "<C-M-Up>", "<cmd>resize +2<cr>", { desc = "Increase Height" })
-- vim.keymap.set("n", "<C-M-Left>", "<cmd>vertical resize -2<cr>", { desc = "Decrease Width" })
-- vim.keymap.set("n", "<C-M-Down>", "<cmd>resize -2<cr>", { desc = "Decrease Height" })
-- vim.keymap.set("n", "<C-M-Right>", "<cmd>vertical resize +2<cr>", { desc = "Increase Width" })
vim.keymap.set("n", "<C-M-k>", "<cmd>resize +2<cr>", { desc = "Increase Height" })
vim.keymap.set("n", "<C-M-h>", "<cmd>vertical resize -2<cr>", { desc = "Decrease Width" })
vim.keymap.set("n", "<C-M-j>", "<cmd>resize -2<cr>", { desc = "Decrease Height" })
vim.keymap.set("n", "<C-M-l>", "<cmd>vertical resize +2<cr>", { desc = "Increase Width" })
